...
## Appendix A — `assets/rade.css` (temporary)

Paste this verbatim into `src/ui/apps/rade_analytics/assets/rade.css`, replacing the current contents. This appendix will be removed once verified on the work env (per the usual pattern).
...
.rade-splash-card {
  ...
  border: 1px solid #1e293b;
  border-radius: 1rem;
  box-shadow: 0 25px 50px -12px rgb(2 6 23 / 0.5);
}
