...
- ml: Machine learning training (deep hedging, GNN pricer)
...
def register_builtin_pipelines(registry: PipelineRegistry) -> None:
    ...
    # Build timeseries dataset from synthetic or external providers
    ...
    # Replay static dataset from file/artifacts
    # Note: replay_static exists but may not have build_pipeline exported
    try:
    ...
    # Bootstrap yield curves from rate quotes
    ...
    # Build portfolio from YAML/JSON configuration
    ...
    # Construct hedge portfolio to neutralise Greek exposures
    ...
    # Price portfolio using pricer registry
    ...
    # Run scenario analysis (spot/vol/rate shocks)
    ...
    # Compute portfolio sensitivities (Greeks) with aggregation
    ...
    # Validate analytic Greeks against bump-and-reprice
    ...
    # Calibrate volatility surface (SABR, Dupire, SVI)
    ...
    # Calibrate Hull-White short rate model
    ...
    # Train GNN-RNN hybrid pricing model
    ...
    # Train ML calibration accelerator
    ...
    # Compare pricing results across models
...
def get_default_registry() -> PipelineRegistry:
    """
    Create and return a PipelineRegistry with all built-in pipelines registered.
    
    Returns
    -------
    PipelineRegistry
        Registry populated with all available pipelines.
    """
