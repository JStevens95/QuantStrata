"""
Hyperparameter tuning pipeline for the Hybrid GNN-RNN model.
...
from src.rade_ml.pipelines.base import TunePipeline
...
class HybridGnnRnnTunePipeline(TunePipeline):
    ...
    def build_trial_model(
        ...
        from src.rade_ml.models.hybrid_gnn_rnn.config import HybridGnnRnnModelConfig
