...
class TradeAttributeEncoder:
    ...
    def __init__(
            ...
            ttm_key: str = 'yrs_to_maturity', num_decay_terms: Optional[Union[int, List[float]]] = None
    ) -> None:
        """
        ...
        :param multi_label_keys:
        :param ttm_key:
        :param num_decay_terms:
        """
        ...
        self.ttm_decay_lambdas = list(np.linspace(10.0, 0.1, num_decay_terms)) if (
            isinstance(num_decay_terms, int)) else num_decay_terms
