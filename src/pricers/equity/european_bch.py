# src/pricers/equity/european_bch.py
"""
Equity European Option Bachelier Pricers.

Prices equity options using the Bachelier (normal) model. Appropriate for:
...
# =============================================================================
# EQUITY SPREAD OPTION BACHELIER PRICERS
# =============================================================================
...
class EquitySpreadEuropeanOptionBchPricer:
    ...
    def _to_simple(
        ...
        # Forward spread (assuming no dividends for simplicity).
